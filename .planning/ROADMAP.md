...
| 36. The Conversational Path | **v5** | 0/TBD | Run against a real server; answer reached and every citation resolved, but the guest vocabulary is unreachable from the surface — report in `.planning/reports/` | 2026-09-07 |
