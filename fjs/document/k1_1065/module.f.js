 ...
 *
 * Sixteen of the eighteen fixed-caption money boxes are here. The boxes that
...
export const unmodeledMoneyBoxes = /** @type {const} */ ([
    ...
    ['box21ForeignTaxesPaidOrAccrued', 'Schedule 3 line 1 (foreign tax credit), through Form 1116 — `foreignTaxCredit` is an `fjs/return/scope` refusal'],
])
