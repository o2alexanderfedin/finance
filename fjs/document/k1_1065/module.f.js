...
export const unmodeledMoneyBoxes = /** @type {const} */ ([
    ['box2NetRentalRealEstateIncome', 'Schedule E PART II, the passive columns of printed line 28, after Form 8582 — NOT Part I. Printed Part I is one column per property the taxpayer owns directly, and a partner owns an interest in the partnership rather than in its buildings, so this share cannot become a Part I column even though Part I now computes. What it needs is Form 8582, which needs every passive activity on the return and every prior-year unallowed loss'],
